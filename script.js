...
window.onload = () => {
  ...
  if (location.pathname == "/index.html"||location.pathname=="/"||location.pathname==""||location.pathname=="/PersonalWebsite/"||location.pathname == "/index.html/"||location.pathname=="/PersonalWebsite/index.html") {
    typewriter();
  }
};
